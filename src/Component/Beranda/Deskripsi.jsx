      ...
      <div className="flex flex-col md:flex-row items-center md:items-stretch justify-center gap-6 md:gap-16">
        ...
        <TiltCard>
          <img
            ...
            className="flex sm:h-[350px] md:h-[500px] object-contain rounded-xl"
          />
        </TiltCard>
                    ...
                    <div className="flex justify-between items-center">
                      ...
                      >
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 24 24" fill="currentColor">
                          <path d="M17.472 14.382c-.297-.148-1.757-.867-2.03-.967-.272-.099-.47-.149-.669.149-.197.297-.766.966-.94 1.164-.173.198-.346.223-.644.075-.297-.149-1.254-.462-2.388-1.475-.883-.788-1.48-1.761-1.653-2.06-.173-.297-.018-.458.13-.605.133-.134.297-.347.446-.52.148-.174.197-.297.297-.496.099-.199.049-.371-.026-.52-.075-.148-.669-1.612-.914-2.207-.243-.58-.488-.501-.669-.51-.174-.01-.371-.01-.57-.01-.198 0-.52.074-.792.371-.273.298-1.04 1.017-1.04 2.479 0 1.463 1.065 2.875 1.213 3.073.148.198 2.096 3.2 5.075 4.487.709.307 1.262.49 1.693.626.712.226 1.36.194 1.871.118.571-.086 1.758-.72 2.006-1.413.248-.694.248-1.289.173-1.414-.074-.124-.272-.198-.57-.347zM12.005 2.004c-5.522 0-10 4.477-10 9.999 0 1.76.466 3.467 1.349 4.966L2 22l5.153-1.348c1.47.803 3.129 1.227 4.852 1.227 5.522 0 10-4.477 10-9.999 0-2.669-1.04-5.179-2.929-7.06A9.94 9.94 0 0 0 12.005 2.004zm0 18.329c-1.545 0-3.045-.409-4.362-1.184l-.313-.185-3.061.799.814-2.978-.2-.319a8.361 8.361 0 0 1-1.312-4.485c0-4.626 3.77-8.395 8.438-8.395 2.258 0 4.377.879 5.962 2.466a8.36 8.36 0 0 1 2.476 5.957c0 4.627-3.77 8.394-8.44 8.394z" />
                        </svg>
                        WhatsApp
                      </a>
                    </div>
