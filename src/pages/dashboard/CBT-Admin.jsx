...
export function Layanan() {
  ...
  return (
    <div className="p-4 bg-blue-50 min-h-screen">
      {/* Header */}
      <Typography variant="h6" className="mb-4 font-bold text-blue-800">
        Daftar Peserta CBT
      </Typography>
      ...
      <div className="flex flex-col md:flex-row justify-between items-center mb-4 gap-4">
        ...
        <div className="relative w-full md:w-1/3">
          <Input
            ...
            className="pr-8 rounded-md shadow-sm focus:ring-1 focus:ring-blue-500 text-sm"
          />
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-xs text-left text-gray-700">
              <thead className="bg-blue-100 border-b border-blue-300">
                <tr>
                  <th className="py-1 px-2 font-semibold text-blue-800">ID</th>
                  <th className="py-1 px-2 font-semibold text-blue-800">Nama</th>
                  <th className="py-1 px-2 font-semibold text-blue-800">Email</th>
                  <th className="py-1 px-2 font-semibold text-blue-800">Status</th>
                  <th className="py-1 px-2 font-semibold text-blue-800">Jenjang</th>
                  <th className="py-1 px-2 font-semibold text-blue-800">Waktu Diverifikasi</th>
                  <th className="py-1 px-2 font-semibold text-blue-800">Aksi</th>
                </tr>
              </thead>
              <tbody>
                {currentItems.map((participant, idx) => (
                  <tr
                    ...
                    } border-b border-blue-200 hover:bg-blue-100 transition duration-150`}
                  >
                    ...
                    <td className="py-1 px-2">
                      <Button
                        ...
                        className="rounded-full text-[9px] px-2 py-0.5 normal-case bg-blue-500 hover:bg-blue-600 text-white"
                      >
                        Detail
                      </Button>
                    </td>
