...
export function Testimoni() {
    ...
    const handleFileChange = (e) => {
        ...
        if (file) {
            setFormData((prevState) => ({
                ...prevState,
                image: file,
                imagePreview: URL.createObjectURL(file), // Set new image preview
            }));
        }
    };
    ...
    const handleSubmitTestimoni = async () => {
        ...
        try {
            ...
            setFormData({
                ...
                feedback: "",
                image: null,
                imagePreview: "", // Reset preview after submit
            });
        } catch (error) {
    ...
    const handleEdit = (item) => {
        ...
        setFormData({
            ...
            image: null,
            // If there's an existing image, set the preview to the URL
            imagePreview: item.image_url || "", // Use the URL or empty string if no image
        });
    };
